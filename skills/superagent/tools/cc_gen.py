...
BIN: 6233586370 (UnionPay)
Source: https://dummylabs.live/cc-gen
"""
import json
import random
...
def generate_cc(bin_number: str, count: int = 5) -> list[dict]:
...
if __name__ == "__main__":
    import sys
    bin_arg = sys.argv[1] if len(sys.argv) > 1 else "6233586370"
