# sk55 — Self-Improvement & Autonomous Fix (SUPERAGENT V7)
...
4. DIAGNOSE → pas ada masalah, jalanin pola sk54 (debug) OTOMATIS tanpa diminta
...
> Ini bedanya "agent yang nyatet" vs "agent yang makin tajam": bukan cuma inget, tapi naikin yang berulang jadi default. Dikawal `tools/eval.py` (sk56) — instinct yang variance-nya jelek gak boleh jadi reflex.
...
✗ Edit file FROZEN (SOUL, AGENTS, governor.*, mev.py, security.md,
  skill_integrity.py, reflection.py, USER.md, sk55.md)
