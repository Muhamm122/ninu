# sk13 — Universal NFT Minter (SUPERAGENT V7)
# Load when: mint, opensea, manifold, zora, seadrop, NFT, claim, drop, collection
...
## Step 7 — Mass mint with N wallets (combo with sk12)
```js
...
- **`InvalidMerkleProof`** → it's allowlist-only, public mint not started, sk13 won't help here without proof
