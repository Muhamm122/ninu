# sk17 — Power Pack: Planner/Swarm/Automation (SUPERAGENT V7)
# Load when: rencanain, workflow, otomatis kalau, backtest, dashboard, swarm, voice mode
...
forge_proposal("belum bisa baca Chainlink oracle", "sk18")   # → proposal, REVIEW dulu
```

Agent numbuhin kemampuannya sendiri — tapi lewat proposal (sk55/frozen-paths), operator yang acc + re-lock.
...
# serve dari VPS (sk2/sk9). KASIH AUTH, jangan public polos.
```
...
Dua arah: lo ngomong, agent jawab suara. Lengkapin voice input sk15.
