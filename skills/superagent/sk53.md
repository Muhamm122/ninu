# sk53 — Deep Decomposition & Strategy (SUPERAGENT V7)
# Load when: decompose, breakdown, strategy, strategi, deep analysis, dekomposisi, pecah masalah
...
NOT for: single-step tasks, well-defined builds, debug (use sk54).
...
One-way door (expensive to reverse) → spend time on sk53, get it right.

Examples:
- Pick framework for prototype = two-way → decide in 5 min
- Pick chain for token launch = one-way → sk53 full protocol
- Hire someone = one-way → sk53
